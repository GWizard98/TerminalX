...
use crate::decentralized_network::{DecentralizedThreatNetwork, SecurityNode};
...
impl AdaptiveVpnManager {
    ...
    pub fn get_status(&self) -> VpnStatus {
        match &self.active_connection {
            Some(conn) => VpnStatus {
                ...
                security_level: Some(conn.route.security_level.clone()),
    ...
    pub async fn connect_with_circuit(&mut self, server_name: &str, security_level: crate::vpn_circuits::SecurityLevel) -> Result<ConnectionInfo> {
        use crate::vpn_circuits::SecurityLevel as VpnSecurityLevel;
    ...
    pub async fn analyze_traffic_threats(&self, threat_threshold: f64) -> Result<TrafficAnalysisResult> {
...
pub struct ConnectionInfo {
    ...
    pub security_level: crate::vpn_circuits::SecurityLevel,
